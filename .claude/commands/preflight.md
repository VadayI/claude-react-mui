...
Confirm the stack is declared in `CLAUDE.md` and `package.json` with consistent versions: React 19 · Vite 8 · MUI 9 · TypeScript · React Router 6 · TanStack Query 5 · Zustand 5 · Vitest+RTL+MSW · Playwright. If undeclared or contradictory → STOP and confirm with the user.
