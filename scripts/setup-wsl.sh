...
echo ""
info "Next steps:"
echo "  1. Put secrets in the project .env (gitignored — NOT in your shell rc):"
echo "       GITHUB_PERSONAL_ACCESS_TOKEN=github_pat_..."
echo "       CONTEXT7_API_KEY=..."
echo "  2. (optional) Authenticate gh for non-wrapped shells:  gh auth login"
echo "  3. Start Claude:     make cc      # sources .env so the token reaches the MCPs & gh"
echo "  4. Run doctor:       /doctor"
echo ""
