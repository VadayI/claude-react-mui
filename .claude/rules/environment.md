...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| Plugins (committed baseline)    | `superpowers@superpowers-marketplace`, `playwright@claude-plugins-official`, `github@claude-plugins-official`, `context7@claude-plugins-official` (auto-enabled via `.claude/settings.json`). `claude-hud` recommended but personal/global, not committed. | `/plugin` list vs `.claude/settings.json` `enabledPlugins`   |
