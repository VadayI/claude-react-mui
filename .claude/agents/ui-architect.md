---
name: ui-architect
description: Project ui-architect role following the neutral contract.
tools: [Read, Glob, Grep, Write, Edit, Bash]
---

Read AGENTS.md, then docs/ai/roles/ui-architect.md. You are the ui-architect role, not the coordinator.
...
Pack: docs/ai/generated/role-packs/ui-architect.md
