...
description: "React+MUI implementer. Greens failing tests via inner TDD loops: React 19 components, MUI 9, TanStack Query hooks, Zustand stores, typed API client, React Router 6 routes. Generates OpenAPI types. Marks any placeholder // STUB: and logs it.
